                 ...
                 <div className = "flex gap-4 items-center ">
                     ...
                     <div className = "flex gap-2 group relative px- rel items-center">
                         ...
                         <div onClick = {toggleBox} className = " w-full cursor-pointer  h-full" >
                            ...
                            {(show || false )&& (
                              <div className =  {`${show ? "block lg:hidden": "hidden"} group-hover:block lg:hidden block  absolute w-60 bg-white top-11 right-0 border-1 border-[#F1F2F3] rounded-md`}>
                                <div className = 'p-3 flex flex-col gap-[7px] items-center '>
                                  ...
                                  <div className = 'flex flex-col gap-1 '>
                                    <div className = 'flex gap-1 justify-center  '>
                                      ...
                                      <span className = 'font-sans font-medium text-[#161E54] text-[0.97rem] '>{user && user?.lastName?.charAt(0).toUpperCase() + user.lastName?.slice(1) }</span>
                                      {/* <p className = 'mt-[-4px] font-normal font-sans text-sm text-[#78808A]'>{user && user.role}</p> */}
                                    </div>
                                      <p className = 'mt-[-5px] font-normal font-sans text-xs text-[#ACACAC]'>{user && user?.email}</p>
                                  </div>
                                </div>
                                  <hr className = 'py-2 text-[#F1F2F3]'/>
                              </div>
                            )}
